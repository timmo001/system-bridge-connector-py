...
def test_network(network_fixtrue_response):
    ...
    assert obj.connections[0].protocol == network_fixtrue_response['connections'][0]['protocol']
    assert obj.connections[0].localAddress == network_fixtrue_response['connections'][0]['localAddress']
    assert obj.connections[0].localPort == network_fixtrue_response['connections'][0]['localPort']
    assert obj.connections[0].peerAddress == network_fixtrue_response['connections'][0]['peerAddress']
    assert obj.connections[0].peerPort == network_fixtrue_response['connections'][0]['peerPort']
    assert obj.connections[0].state == network_fixtrue_response['connections'][0]['state']
    assert obj.connections[0].pid == network_fixtrue_response['connections'][0]['pid']
    assert obj.connections[0].process == network_fixtrue_response['connections'][0]['process']
    ...
    assert obj.interfaces[0].ifaceName == network_fixtrue_response['interfaces'][0]['ifaceName']
    assert obj.interfaces[0].ip4 == network_fixtrue_response['interfaces'][0]['ip4']
    assert obj.interfaces[0].ip4subnet == network_fixtrue_response['interfaces'][0]['ip4subnet']
    assert obj.interfaces[0].ip6 == network_fixtrue_response['interfaces'][0]['ip6']
    assert obj.interfaces[0].ip6subnet == network_fixtrue_response['interfaces'][0]['ip6subnet']
    assert obj.interfaces[0].mac == network_fixtrue_response['interfaces'][0]['mac']
    assert obj.interfaces[0].internal == network_fixtrue_response['interfaces'][0]['internal']
    assert obj.interfaces[0].virtual == network_fixtrue_response['interfaces'][0]['virtual']
    assert obj.interfaces[0].operstate == network_fixtrue_response['interfaces'][0]['operstate']
    assert obj.interfaces[0].type == network_fixtrue_response['interfaces'][0]['type']
    assert obj.interfaces[0].duplex == network_fixtrue_response['interfaces'][0]['duplex']
    ...
    assert obj.interfaces[0].dnsSuffix == network_fixtrue_response['interfaces'][0]['dnsSuffix']
    assert obj.interfaces[0].ieee8021xAuth == network_fixtrue_response['interfaces'][0]['ieee8021xAuth']
    assert obj.interfaces[0].ieee8021xState == network_fixtrue_response['interfaces'][0]['ieee8021xState']
    assert obj.interfaces[0].carrierChanges == network_fixtrue_response['interfaces'][0]['carrierChanges']
