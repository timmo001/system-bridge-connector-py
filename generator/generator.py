...
def generateclass(name, data, primary=False):
    ...
    fixturefilename = f"tests/fixtrues/{'/'.join([x.lower() for x in re.findall('[A-Z][a-z]*', classname)])}_fixtrue.py"
    ...
    with open(
        ...
        fixturefile.write(json.dumps(data))
